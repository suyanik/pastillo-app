...
const SuccessView: React.FC<Props> = ({ reservation, onReset, lang }) => {
  ...
  const labels: Record<string, { title: string; details: string; date: string; time: string; name: string; guests: string; save: string; google: string; home: string }> = {
    ...
    es: { title: '¡Confirmado!', details: 'Detalles', date: 'Fecha', time: 'Hora', name: 'Nombre', guests: 'Invitados', save: 'Guardar en Calendario', google: 'Google Calendar', home: 'Volver al Inicio' }
  };
